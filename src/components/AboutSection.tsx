          ...
          >
            ...
            <div className="space-y-6 text-charcoal/80 relative z-10">
              <p className="text-lg leading-relaxed">
                With over 8 years of experience in digital art and concept design, 
                I specialize in creating immersive worlds and compelling characters 
                for the gaming and entertainment industry.
              </p>
              
              <p className="text-lg leading-relaxed">
                My work spans from initial concept sketches to final production art, 
                with a focus on narrative-driven design that enhances storytelling 
                and player engagement.
              </p>
              
              <div className="pt-6">
                <h3 className="handwritten text-2xl mb-4 text-charcoal">Specialties</h3>
